...
@router.get("", response_model=AlertListResponse, summary = "List stored alerts",)
async def list_aletrs(service: str | None = None, metric: str |None = None, limit: Annotated[int, Query(ge=1, le=500)] = 100, severity: str | None = None,session : AsyncSession = Depends(get_db_session)) -> AlertListResponse:
